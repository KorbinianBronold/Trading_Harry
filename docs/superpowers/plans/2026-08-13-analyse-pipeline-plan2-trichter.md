...
4. **Task 11s Pseudocode schlägt modulweiten State vor** (`_rate_limiter: dict` auf
   Modulebene, mit einem nie gelesenen `last_reset`-Schlüssel). Implementiert stattdessen
